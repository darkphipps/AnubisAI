...
__all__ = [
    'DISPID_SGRsFindRule', 'DISPID_SOTCDefault', 'SVSFlagsAsync',
    'eLEXTYPE_PRIVATE5', 'SASClosed', 'SAFT48kHz16BitMono',
    'SECHighConfidence', 'DISPID_SRCERecognition', 'SPGRAMMARSTATE',
    'ISpPhraseAlt', 'SpeechCategoryAppLexicons', 'SAFT16kHz8BitMono',
    'SECLowConfidence', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SAFType', 'SAFT11kHz8BitMono', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFT32kHz8BitStereo', 'SPCT_COMMAND', 'SPLEXICONTYPE',
    'Speech_Max_Word_Length', 'DISPID_SPRFirstElement',
    'DISPID_SVEPhoneme', 'DISPID_SLPLangId',
    'DISPID_SRGCmdSetRuleState', 'SVEAudioLevel', 'DISPID_SPAsCount',
    'SPSHORTCUTTYPE', 'DISPID_SLPsItem', 'SPEI_VISEME',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SPILanguageId',
    'DISPID_SGRsCommit', 'DISPID_SRRSetTextFeedback',
    'SpeechLexiconType', 'ISpeechRecoResultDispatch',
    'SPCATEGORYTYPE', 'ISpeechPhoneConverter',
    'DISPID_SABIBufferSize', 'SPPHRASERULE', 'DISPID_SpeechAudio',
    'STCAll', 'DISPID_SRIsShared', 'SVSFPersistXML',
    'DISPID_SLRemovePronunciation', 'DISPID_SLPType',
    'DISPID_SLPs_NewEnum', 'SGRSTTRule', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechTokenKeyUI', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRCEEnginePrivate', 'SPVPRI_OVER', 'DISPID_SDKOpenKey',
    'DISPID_SRRTStreamTime', 'SPWORD', 'SPEI_START_SR_STREAM',
    'SPRECOCONTEXTSTATUS', 'SpeechRunState',
    'DISPID_SpeechPhraseInfo', 'ISpeechDataKey', 'ISpGrammarBuilder',
    'SpeechPropertyLowConfidenceThreshold', 'SAFT48kHz8BitMono',
    'SRTReSent', 'DISPID_SPPName', 'SpeechRuleState',
    'SAFT22kHz16BitStereo', 'DISPID_SRCEFalseRecognition',
    'DISPID_SOTCGetDataKey', 'Speech_Max_Pron_Length',
    'SPPS_Function', 'DISPID_SVSpeakCompleteEvent',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFTADPCM_8kHzMono',
    'SPEVENTSOURCEINFO', 'SREAdaptation', 'SAFT16kHz16BitStereo',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SOTSetId',
    'DISPID_SDKEnumValues', 'DISPID_SOTsCount', 'DISPID_SRCVoice',
    'SVSFParseSsml', 'SPEI_INTERFERENCE', 'DISPID_SOTGetDescription',
    'DISPID_SPRuleChildren', 'SSTTDictation', 'DISPID_SLWType',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SOTDataKey',
    'DISPID_SpeechCustomStream', 'SPCT_SUB_COMMAND', 'DISPID_SFSOpen',
    'DISPID_SOTCEnumerateTokens', 'SPPROPERTYINFO', 'SINone',
    'SpeechRecoProfileProperties', 'DISPID_SPRDisplayAttributes',
    'SPVPRIORITY', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SpeechBaseStream', 'DISPID_SRCEventInterests',
    'ISpeechAudioFormat', 'SpeechFormatType', 'SpeechVoiceEvents',
    'SRTSMLTimeout', 'SPEI_REQUEST_UI',
    'DISPID_SOTGetStorageFileName', 'DISPID_SASCurrentDevicePosition',
    'SP_VISEME_0', 'DISPID_SBSFormat', 'ISpeechWaveFormatEx',
    'DISPID_SPEsCount', 'DISPID_SDKGetStringValue',
    'SAFTCCITT_uLaw_44kHzMono', 'SPPS_RESERVED2', 'SP_VISEME_15',
    'ISpStreamFormat', 'eLEXTYPE_PRIVATE18',
    'SpeechPropertyHighConfidenceThreshold', 'SVEViseme',
    'SPWT_PRONUNCIATION', 'SpInProcRecoContext',
    'DISPID_SPIAudioSizeTime', 'ISpeechPhraseProperty',
    'ISpSerializeState', 'DISPID_SPEPronunciation',
    'SPEI_RECO_STATE_CHANGE', 'eLEXTYPE_PRIVATE8',
    'DISPID_SPIEngineId', 'SpeechEngineConfidence',
    'SSSPTRelativeToEnd', 'SPVOICESTATUS', 'DISPID_SDKSetStringValue',
    'DISPID_SRAudioInputStream', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRCERequestUI',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRCEInterference',
    'eLEXTYPE_RESERVED4', 'SPSFunction', 'DISPID_SpeechRecoResult',
    'DISPID_SVGetAudioInputs', 'STCLocalServer', 'SPSEMANTICFORMAT',
    'DISPID_SPRsItem', 'SECFIgnoreKanaType', 'DISPID_SVSpeakStream',
    'DISPID_SpeechObjectToken', 'SPPS_LMA',
    'DISPID_SRGDictationSetState', 'SPSModifier', 'SVP_2',
    'DISPID_SVSLastBookmark', 'SPPS_Modifier', 'SAFT32kHz16BitStereo',
    'DISPID_SOTCreateInstance', 'DISPID_SRCEPropertyStringChange',
    'SPGS_DISABLED', 'DISPID_SpeechLexiconWords',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SpeechPhraseElements',
    'SpeechRuleAttributes', 'SREFalseRecognition', 'SPRULESTATE',
    'SVP_18', 'DISPID_SRRAudioFormat', 'SAFT11kHz8BitStereo',
    'DISPID_SpeechVoiceStatus', 'DISPID_SpeechGrammarRuleState',
    'ISpRecognizer', 'SAFT24kHz8BitMono', 'SDTLexicalForm',
    'SpeechVisemeType', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SECFIgnoreCase', 'SRSEDone', 'SPWORDPRONUNCIATION',
    'SpeechSpecialTransitionType', 'SAFTADPCM_44kHzMono',
    'DISPID_SGRSTs_NewEnum', 'SPCS_ENABLED', 'DISPID_SRCEHypothesis',
    'DISPID_SGRs_NewEnum', 'ISpeechFileStream',
    'DISPID_SWFESamplesPerSec', 'SpeechPropertyResourceUsage',
    'SDTAudio', 'DISPID_SVSInputSentencePosition',
    ...
    'eLEXTYPE_PRIVATE14', 'SPPS_RESERVED3', 'SAFTGSM610_44kHzMono',
    'DISPID_SPRNumberOfElements', 'SAFTDefault', 'DISPID_SOTRemove',
    'DISPID_SLGetWords', 'SPSHT_OTHER', 'SRESoundStart',
    'SpeechGrammarWordType', 'SREPropertyNumChange', 'DISPID_SVSpeak',
    'DISPID_SGRAttributes', 'SGSEnabled', 'ISpDataKey', 'SPSHT_EMAIL',
    'DISPID_SpeechObjectTokens', 'ISpRecoContext2',
    'DISPID_SVSVisemeId', 'DISPID_SMSAMMHandle', 'SWTAdded',
    'SVEStartInputStream', 'DISPID_SGRSTsCount',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPINTERFERENCE',
    'ISpeechRecoContext', 'eLEXTYPE_PRIVATE17', 'SAFT24kHz16BitMono',
    'DISPID_SRCESoundStart', 'SpeechAudioFormatGUIDText',
    'SpPhoneticAlphabetConverter', 'SRSEIsSpeaking',
    'ISpeechPhraseAlternates', 'SRERequestUI', 'SPRS_INACTIVE',
    'SPBO_PAUSE', 'ISpEventSink', 'DISPID_SpeechVoice',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPSMF_SAPI_PROPERTIES',
    'ISpeechGrammarRuleState',
    'DISPID_SRCERecognitionForOtherContext', 'SpeechRecognitionType',
    'DISPID_SVEVoiceChange', 'eLEXTYPE_RESERVED8',
    'ISpPhoneConverter', 'SVSFNLPMask', 'DISPID_SRCRecognizer',
    'SP_VISEME_13', 'SVESentenceBoundary', 'SGDSActiveUserDelimited',
    'SPRECORESULTTIMES', 'ISpRecoContext', 'DISPID_SPELexicalForm',
    'DISPID_SRGIsPronounceable', 'ISpeechPhraseReplacement',
    'SP_VISEME_21', 'SPAS_PAUSE', 'SPPS_Verb', 'DISPID_SRGetFormat',
    'DISPID_SPRulesItem', 'DISPID_SMSGetData', 'SPGS_EXCLUSIVE',
    'DISPID_SpeechMemoryStream', 'SPEI_SR_PRIVATE',
    'SpeechRegistryLocalMachineRoot', 'IStream', 'DISPID_SPIGetText',
    'SECNormalConfidence', 'SP_VISEME_8', 'DISPID_SpeechPhraseRules',
    'SDTAlternates', 'SPAO_NONE', 'DISPID_SGRSAddRuleTransition',
    'SPVPRI_ALERT', 'SpeechDataKeyLocation', 'SAFT44kHz16BitMono',
    'SpeechTokenContext', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SOTsItem', 'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpRecognizer3', 'DISPID_SMSADeviceId', 'DISPID_SLPPhoneIds',
    'SpNullPhoneConverter', 'SpUnCompressedLexicon',
    'DISPID_SVSInputWordLength', 'DISPID_SRStatus', 'ISpObjectToken',
    'ISpStreamFormatConverter', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechRecoResult2', 'SAFT22kHz8BitMono',
    'DISPID_SASState', 'SpCustomStream', 'eLEXTYPE_PRIVATE9',
    'SPAR_Medium', 'DISPID_SVESentenceBoundary', 'SAFT8kHz16BitMono',
    'DISPID_SGRsDynamic', 'DISPID_SPRuleNumberOfElements',
    'SPLO_DYNAMIC', 'SPGRAMMARWORDTYPE', 'Speech_StreamPos_RealTime',
    'SP_VISEME_20', 'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPRsCount',
    'SpSharedRecognizer', 'SPCONTEXTSTATE', 'SVEPrivate',
    'SVF_Stressed', 'SRTEmulated', 'DISPID_SDKGetBinaryValue',
    'SPSVerb', 'SLTApp', 'SREInterference', 'SPCS_DISABLED',
    'DISPID_SDKEnumKeys', 'SVP_19', 'DISPID_SpeechPhraseProperty',
    'SAFT11kHz16BitStereo', 'DISPID_SGRSTRule', 'ISpeechLexiconWord',
    'SpeechCategoryPhoneConverters', 'DISPID_SPRuleId',
    'SpeechTokenKeyFiles', 'SDA_One_Trailing_Space', 'SPAR_High',
    'eWORDTYPE_ADDED', 'DISPID_SRCRetainedAudio',
    'DISPID_SGRSTNextState', 'DISPID_SPRs_NewEnum', 'ISpEventSource',
    'SDTProperty', 'SP_VISEME_5', 'DISPID_SOTCSetId',
    'DISPID_SREmulateRecognition',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCCreateResultFromMemory', 'SRAExport',
    'SWPUnknownWordUnpronounceable', 'SREBookmark',
    'ISpeechRecoResult2', 'SGSDisabled', 'DISPID_SBSSeek',
    'SPSERIALIZEDRESULT', 'SRAONone', 'SPFM_CREATE',
    'SpeechRegistryUserRoot', 'SGDisplay',
    'DISPID_SRCRequestedUIType', 'SPVPRI_NORMAL', 'SpMemoryStream',
    ...
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechCategoryVoices',
    'DISPID_SVGetProfiles', 'SAFT12kHz8BitStereo', 'SPSNoun',
    'ISpRecoGrammar', 'eLEXTYPE_PRIVATE3', 'SAFT8kHz8BitMono',
    'SPPS_Noncontent', 'DISPID_SBSWrite', 'UINT_PTR',
    'SpeechCategoryAudioIn', 'SPSMF_UPS',
    'SPRS_ACTIVE_USER_DELIMITED', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRGDictationLoad', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRSSupportedLanguages', 'SPCT_DICTATION',
    'DISPID_SVEEnginePrivate', 'SDKLLocalMachine',
    'DISPID_SRGetPropertyString', 'eLEXTYPE_MORPHOLOGY', 'SVF_None',
    'SVSFParseSapi', 'SPFM_OPEN_READONLY', 'DISPID_SPAsItem',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechGrammarTagUnlimitedDictation', 'SSFMCreate',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPCPhoneToId',
    'DISPID_SLWs_NewEnum', 'SECFDefault', 'SVP_20', 'SVP_13',
    'SREPropertyStringChange', 'DISPID_SVSInputWordPosition',
    'IInternetSecurityManager', 'SpeechCategoryRecoProfiles',
    'SpeechDictationTopicSpelling', 'SPINTERFERENCE_TOOQUIET',
    'SP_VISEME_17', 'SpResourceManager', 'SPAUDIOSTATE', 'SPFILEMODE',
    'DISPID_SWFEBlockAlign', 'DISPID_SRGSetTextSelection', 'SVP_15',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFTGSM610_8kHzMono',
    'SpeechInterference', 'ISpeechPhraseRule', 'DISPID_SGRSRule',
    'SGLexicalNoSpecialChars', 'SpPhoneConverter', 'SLOStatic',
    'DISPID_SVSInputSentenceLength', 'SPEI_HYPOTHESIS', 'SVPOver',
    'SAFT8kHz16BitStereo', 'SPEI_FALSE_RECOGNITION',
    'SRAORetainAudio', 'SPPHRASE', 'STSF_CommonAppData',
    'DISPID_SRRTimes', 'SPINTERFERENCE_TOOSLOW', 'SPWORDTYPE',
    'SpTextSelectionInformation', 'SVSFNLPSpeakPunc',
    'DISPID_SPANumberOfElementsInResult', 'SGLexical',
    '_RemotableHandle', 'ISpeechAudioBufferInfo', 'DISPID_SRGCommit',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRSetPropertyString',
    'DISPID_SRCPause', 'eLEXTYPE_RESERVED7', 'SREStateChange',
    'SpeechCategoryAudioOut', 'DISPID_SPRulesCount',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SVPriority',
    'SAFT44kHz8BitStereo', 'DISPID_SVResume', 'SPEVENT',
    'DISPID_SPPConfidence', 'eLEXTYPE_PRIVATE7', 'SpAudioFormat',
    'SRCS_Disabled', 'SVSFUnusedFlags', 'ISpMMSysAudio',
    'SPWORDPRONOUNCEABLE', 'DISPID_SBSRead', 'DISPID_SOTDisplayUI',
    'DISPID_SpeechPhraseReplacement', 'SSFMOpenForRead',
    'SpeechVoiceSpeakFlags', 'eLEXTYPE_PRIVATE13',
    'SVSFPurgeBeforeSpeak', 'SpFileStream',
    'ISpPhoneticAlphabetConverter', 'DISPID_SLWWord', 'SPBO_NONE',
    'DISPID_SPRuleParent', 'SpeechWordPronounceable',
    'SPPS_RESERVED4', 'DISPID_SpeechPhoneConverter',
    'SPEI_VOICE_CHANGE', 'SPEI_RESERVED2', 'SpLexicon',
    'SAFTCCITT_uLaw_8kHzMono', 'SPINTERFERENCE_TOOLOUD',
    'SpeechDiscardType', 'DISPID_SRRDiscardResultInfo',
    'ISpeechCustomStream', 'SPSInterjection', 'DISPID_SPIGrammarId',
    'SVP_12', 'SREPrivate', 'eLEXTYPE_RESERVED6', 'SPSSuppressWord',
    'DISPID_SPACommit', 'DISPID_SPPParent', 'ISpNotifySink',
    'DISPID_SGRsAdd', 'SRCS_Enabled', 'DISPID_SLPsCount',
    'SPFM_NUM_MODES', 'SITooSlow', 'ISpeechGrammarRule',
    'DISPID_SVPause', 'SpSharedRecoContext', 'DISPID_SVSPhonemeId',
    'ISpeechRecoResult', 'SpeechAudioFormatGUIDWave',
    'DISPID_SPCLangId', 'SpeechGrammarState',
    'DISPID_SRCEStartStream', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SLWsItem', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPEDisplayText',
    'DISPID_SpeechPhraseReplacements', 'SP_VISEME_3',
    'DISPID_SGRSTsItem', 'DISPID_SGRsItem', 'DISPID_SWFEFormatTag',
    'DISPID_SABIEventBias', 'ISpeechPhraseReplacements',
    'SpeechAddRemoveWord', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPIEnginePrivateData', 'SPEI_END_SR_STREAM',
    'DISPID_SRGRules', 'DISPID_SGRSTType', 'ISpRecoCategory',
    'SPEI_RESERVED3', 'SPFM_CREATE_ALWAYS', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRGDictationUnload', 'DISPID_SPIGetDisplayAttributes',
    'ISpeechGrammarRules', 'SPSUnknown', 'SPDATAKEYLOCATION',
    'SpeechPropertyResponseSpeed', 'SAFTTrueSpeech_8kHz1BitMono',
    'eLEXTYPE_PRIVATE1', 'DISPID_SRCVoicePurgeEvent',
    'SpeechRecognizerState', 'SPDKL_DefaultLocation',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechResourceLoader',
    'DISPID_SDKSetLongValue', 'DISPID_SPAStartElementInResult',
    'ISpXMLRecoResult', 'DISPID_SAFSetWaveFormatEx', 'SP_VISEME_14',
    'SGDSActiveWithAutoPause', 'SPPHRASEELEMENT', 'SAFT44kHz8BitMono',
    'DISPID_SPPsCount', 'SAFTADPCM_11kHzMono', 'DISPID_SVEAudioLevel',
    'SFTSREngine', 'SINoise', 'SpeechTokenIdUserLexicon',
    'SDA_No_Trailing_Space', '__MIDL_IWinTypes_0009',
    'ISpeechObjectTokenCategory', 'SP_VISEME_11', 'DISPID_SRCResume',
    'SRSInactive', 'eLEXTYPE_PRIVATE11', 'DISPID_SMSSetData',
    'SRSActive', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SGDSActive', 'SPWORDPRONUNCIATIONLIST', 'ISpAudio',
    'DISPID_SRRecognizer', 'DISPID_SpeechPhraseRule', 'SPAR_Low',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SLGetPronunciations', 'SPAS_RUN',
    'SDTAll', 'SpeechRecoEvents', 'DISPID_SVSLastResult',
    'DISPID_SGRId', 'SpMMAudioOut', 'SAFT48kHz16BitStereo',
    'eLEXTYPE_PRIVATE15', 'DISPID_SpeechWaveFormatEx',
    'SPINTERFERENCE_NONE', 'SpeechLoadOption', 'SVP_6', 'ISpLexicon',
    'SAFT16kHz16BitMono', 'DISPID_SGRSTPropertyValue',
    'DISPID_SGRSTransitions', 'SVP_17', 'SWPKnownWordPronounceable',
    'SP_VISEME_4', 'SPEI_MAX_TTS', 'ISpeechAudio', 'tagSTATSTG',
    'SpeechTokenValueCLSID', 'SPXRO_Alternates_SML',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRSClsidEngine',
    'DISPID_SPERequiredConfidence', 'SVP_8', 'ISpeechPhraseElement',
    'DISPID_SRAudioInput', 'SAFT24kHz16BitStereo',
    'SAFTCCITT_ALaw_44kHzStereo', 'SpeechMicTraining',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SOTCategory',
    'SAFTADPCM_8kHzStereo', 'SpeechEngineProperties',
    'DISPID_SGRsCount', 'SPINTERFERENCE_TOOFAST', 'DISPID_SPRuleName',
    'DISPID_SVSRunningState', 'SpObjectToken',
    'eLEXTYPE_LETTERTOSOUND', 'SAFT8kHz8BitStereo', 'SDTReplacement',
    'SPRS_ACTIVE', 'WAVEFORMATEX', 'ISpeechMMSysAudio',
    'SPPS_NotOverriden', 'SVP_3', 'DISPID_SpeechRecoContext',
    'DISPIDSPRG', 'SP_VISEME_19', 'SPPS_SuppressWord',
    'SPEI_PHRASE_START', 'DISPID_SPEs_NewEnum', 'SDKLCurrentConfig',
    'ISpShortcut', 'SAFTADPCM_44kHzStereo', 'eLEXTYPE_PRIVATE4',
    'eLEXTYPE_PRIVATE19', 'ISpProperties', 'SPPS_Interjection',
    'SAFT44kHz16BitStereo', 'SAFT48kHz8BitStereo',
    'DISPID_SRRAlternates', 'DISPID_SRCSetAdaptationData', 'SVP_5',
    'SPLOADOPTIONS', 'DISPID_SVEWord', 'DISPID_SPPsItem',
    'SpObjectTokenCategory', 'DISPID_SRDisplayUI',
    'SPADAPTATIONRELEVANCE', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRGRecoContext', '_ISpeechVoiceEvents',
    'ISpObjectWithToken', 'DISPID_SGRSTText',
    'SpeechPropertyComplexResponseSpeed', 'eLEXTYPE_PRIVATE20',
    'ISpeechTextSelectionInformation', 'SRAInterpreter',
    'DISPID_SPEsItem', 'SAFTNonStandardFormat', 'DISPID_SRState',
    'DISPID_SpeechPhraseProperties', 'SWPUnknownWordPronounceable',
    'Speech_StreamPos_Asap', 'DISPID_SPARecoResult',
    'SpeechAudioFormatType', 'DISPID_SVRate', 'SITooLoud',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRCState', 'SVEAllEvents',
    'IInternetSecurityMgrSite', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SRGCmdLoadFromResource', 'SAFTADPCM_11kHzStereo',
    'SpeechPartOfSpeech', 'SpeechTokenShellFolder',
    'DISPID_SLAddPronunciation', 'DISPID_SRCEEndStream',
    'SPAUDIOBUFFERINFO', 'DISPID_SOTIsUISupported', 'SRSActiveAlways',
    'SSFMCreateForWrite', 'SVP_21', 'SSSPTRelativeToStart', 'SDTRule',
    'SPSNotOverriden', 'ISpeechRecognizerStatus',
    'DISPID_SRRRecoContext', 'SRTAutopause', 'SPAUDIOSTATUS',
    'DISPID_SPEEngineConfidence', 'DISPID_SpeechDataKey',
    'DISPID_SRRGetXMLResult', 'DISPIDSPTSI', 'DISPID_SRGId',
    'SPEI_WORD_BOUNDARY', 'SREStreamStart', 'SBONone',
    'SPPS_RESERVED1', 'SPXRO_SML', 'DISPID_SPCIdToPhone',
    'SpeechStreamSeekPositionType', 'SLODynamic', 'DISPID_SVVolume',
    'DISPID_SAStatus', 'DISPID_SVEViseme',
    'DISPID_SPIRetainedSizeBytes', 'SRATopLevel', 'SPAS_STOP',
    'SAFTADPCM_22kHzMono', 'SSTTTextBuffer', 'SpeechStreamFileMode',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SABufferInfo',
    'DISPID_SRRSaveToMemory', 'SPBO_AHEAD', 'SPEI_UNDEFINED',
    'DISPID_SVGetVoices', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SLPSymbolic', 'DISPID_SVAudioOutputStream',
    'SGRSTTEpsilon', 'ISpeechRecoResultTimes',
    'DISPID_SPEActualConfidence', 'SPBO_TIME_UNITS',
    'DISPID_SPPs_NewEnum', 'DISPID_SPEDisplayAttributes',
    'ISpResourceManager', 'SITooFast', 'ISpNotifySource',
    'SpeechAudioVolume', 'SVP_11', 'DISPID_SPPEngineConfidence',
    'SVSFIsXML', 'SGRSTTDictation', 'DISPID_SVWaitUntilDone',
    'eLEXTYPE_PRIVATE6', 'SPEI_SOUND_END', 'DISPID_SpeechVoiceEvent',
    'SAFTText', 'SPVISEMES', 'SBOPause', 'ISequentialStream',
    'SGPronounciation', 'SpeechRetainedAudioOptions', 'SVP_10',
    'SpVoice', 'DISPID_SRCRetainedAudioFormat',
    'SAFTCCITT_uLaw_11kHzStereo', 'tagSPPROPERTYINFO',
    'DISPID_SpeechRecoContextEvents', 'SVP_7', 'SpNotifyTranslator',
    'eLEXTYPE_RESERVED9', 'SPEI_TTS_PRIVATE', 'SPEI_MAX_SR',
    'DISPID_SLWLangId', 'SECFIgnoreWidth', 'SPEI_MIN_SR',
    'DISPID_SDKGetlongValue', 'DISPID_SPRText', 'SP_VISEME_6',
    'SP_VISEME_2', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechAudioProperties', 'SPEVENTENUM', 'SVSFParseAutodetect',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SGRInitialState',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SGRName',
    'STSF_LocalAppData', 'DISPID_SRGSetWordSequenceData',
    'SPXMLRESULTOPTIONS', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPSHT_NotOverriden', 'SPINTERFERENCE_NOISE',
    'SPSEMANTICERRORINFO', 'SP_VISEME_16', 'SpeechVisemeFeature',
    'SPRECOGNIZERSTATUS', 'DISPID_SASNonBlockingIO', 'SVSFVoiceMask',
    'SPEI_MIN_TTS', 'ISpeechObjectToken', 'DISPID_SPIProperties',
    'SVSFDefault', 'SGRSTTTextBuffer', 'SAFT12kHz8BitMono',
    'DISPID_SDKDeleteKey', 'DISPID_SVSLastBookmarkId',
    'DISPID_SAEventHandle', 'SAFTCCITT_ALaw_8kHzMono', 'ISpeechVoice',
    'SpeechGrammarTagWildcard', 'SPWT_DISPLAY',
    'SPEI_SENTENCE_BOUNDARY', 'SAFT16kHz8BitStereo',
    'ISpPhoneticAlphabetSelection', 'DISPID_SFSClose',
    'SpStreamFormatConverter', 'SRADynamic', 'SPSTREAMFORMATTYPE',
    'SRERecognition', 'SPDKL_LocalMachine', 'SVPAlert', 'SWTDeleted',
    'SPDKL_CurrentUser', 'DISPID_SPRuleConfidence',
    'DISPID_SRGCmdLoadFromFile', 'SAFT11kHz16BitMono',
    'DISPID_SGRAddState', 'SINoSignal', 'STCInprocHandler',
    'DISPID_SGRSAddSpecialTransition', 'SREStreamEnd',
    ...
    'SP_VISEME_7', 'SPWT_LEXICAL', 'SP_VISEME_12', 'DISPID_SOTId',
    'ISpPhrase', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRGCmdSetRuleIdState', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRCESoundEnd', 'ISpeechLexiconWords',
    'DISPID_SpeechGrammarRule', 'ISpVoice',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpeechLexiconPronunciation',
    'DISPID_SMSALineId', 'SPEI_SR_BOOKMARK', 'SPWF_SRENGINE',
    'DISPID_SVEStreamStart', 'DISPID_SLWsCount', 'SpeechAudioState',
    'DISPID_SRRPhraseInfo', 'ISpeechPhraseAlternate',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPWAVEFORMATTYPE',
    'SpeechUserTraining', 'DISPID_SDKCreateKey', 'DISPID_SRGState',
    'SPSHORTCUTPAIR', 'SVEWordBoundary', 'DISPID_SRCEBookmark',
    'ISpeechPhraseProperties', 'SPPHRASEPROPERTY', 'SVSFParseMask',
    'SpeechAllElements', 'SVF_Emphasis', 'SGRSTTWord', 'SRESoundEnd',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SGRClear',
    'DISPID_SLGetGenerationChange', 'SPRST_INACTIVE',
    'DISPID_SLGenerationId', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SGRSTWeight', 'IEnumSpObjectTokens', 'SpStream',
    'SAFTCCITT_ALaw_11kHzMono', '_ISpeechRecoContextEvents',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPCT_SUB_DICTATION',
    'SDKLCurrentUser', 'DISPID_SPPId', 'DISPID_SPRuleFirstElement',
    'DISPID_SRCEAdaptation', 'DISPID_SVIsUISupported', 'SPEI_PHONEME',
    'SGDSInactive', 'SAFTADPCM_22kHzStereo', 'SASPause',
    'eLEXTYPE_USER', 'SPRULE', 'DISPID_SABIMinNotification',
    'SPAR_Unknown', 'DISPID_SpeechLexiconPronunciation', 'SVP_14',
    'DISPID_SRGetRecognizers', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVDisplayUI', 'SPWORDLIST', 'SRADefaultToActive',
    'eLEXTYPE_PRIVATE16', 'ISpeechGrammarRuleStateTransition',
    'SRTStandard', 'SVP_1', 'SPRST_NUM_STATES',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRIsUISupported',
    'SAFT12kHz16BitMono', 'DISPID_SPAPhraseInfo',
    'DISPID_SRCBookmark', 'SPEI_ADAPTATION', 'ISpeechPhraseInfo',
    'eWORDTYPE_DELETED', 'SpeechCategoryRecognizers',
    'SAFTExtendedAudioFormat', 'SpeechGrammarTagDictation', 'SRARoot',
    'SPRECOSTATE', 'SP_VISEME_1', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SOTs_NewEnum', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechGrammarRules', 'SP_VISEME_18',
    'ISpObjectTokenCategory', 'SVP_4', 'SREAllEvents',
    'DISPID_SPPNumberOfElements', 'ISpStream', 'SAFTNoAssignedFormat',
    'DISPID_SGRAddResource', 'eLEXTYPE_APP', 'SPEI_RESERVED5',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechBookmarkOptions',
    'DISPID_SpeechLexiconWord', 'SAFTGSM610_11kHzMono',
    'DISPID_SpeechLexicon', 'SPSLMA', 'SpeechRecoContextState',
    'DISPID_SABufferNotifySize', 'SPCT_SLEEP', 'SP_VISEME_10',
    'SPPS_Unknown', '_SPAUDIOSTATE', 'DISPID_SpeechAudioStatus',
    'DISPID_SRSAudioStatus', 'DISPID_SPIReplacements', 'LONG_PTR',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRSTPropertyId',
    'DISPID_SASetState', 'SASRun',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SDTPronunciation',
    'DISPID_SADefaultFormat', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SVEBookmark', 'ISpeechPhraseInfoBuilder',
    'SPBOOKMARKOPTIONS', 'SpeechGrammarRuleStateTransitionType',
    'SAFT32kHz8BitMono', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SAFGuid', 'DISPID_SASFreeBufferSpace',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SWFEChannels',
    'DISPID_SRRTLength', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRRTTickCount', 'ISpeechBaseStream',
    'SPEI_RECO_OTHER_CONTEXT', 'eLEXTYPE_PRIVATE10',
    'DISPID_SVEventInterests', 'DISPID_SpeechLexiconProns',
    'SpeechWordType', 'DISPID_SCSBaseStream', 'SVP_0',
    'DISPID_SPPFirstElement', 'DISPID_SRProfile', 'STSF_AppData',
    'SpMMAudioIn', 'SVEBookmark', 'SPAUDIOOPTIONS',
    'SDKLDefaultLocation', 'DISPID_SpeechPhraseAlternate', 'SASStop',
    'ISpeechPhraseRules', 'DISPID_SOTCId', 'DISPID_SPIStartTime',
    'SREHypothesis', 'SPEI_RECOGNITION', 'ISpeechMemoryStream',
    'DISPID_SVStatus', 'SVEEndInputStream',
    'SpeechTokenKeyAttributes', 'DISPID_SOTGetAttribute',
    'SGSExclusive', 'DISPID_SVAudioOutput', 'SPSHT_Unknown',
    'DISPID_SRCreateRecoContext', 'DISPID_SPIElements',
    'SPPHRASEREPLACEMENT', 'SVEPhoneme', 'SPTEXTSELECTIONINFO',
    'DISPID_SVGetAudioOutputs', 'ISpeechPhraseElements',
    'DISPID_SGRSAddWordTransition', 'DISPID_SVVoice',
    'SVEVoiceChange', 'eLEXTYPE_RESERVED10',
    'DISPID_SRCCreateGrammar', 'SPRST_ACTIVE', 'SPAO_RETAIN_AUDIO',
    'SPBINARYGRAMMAR', 'SPEI_RESERVED6', 'SECFEmulateResult',
    'ISpNotifyTranslator', 'SPEI_TTS_AUDIO_LEVEL', 'SPEI_SOUND_START',
    'DISPID_SpeechPhraseElement', 'SSFMOpenReadWrite',
    'SPSERIALIZEDPHRASE', 'SpMMAudioEnum', 'SPLO_STATIC', 'SLTUser',
    'SAFT22kHz16BitMono', 'SPSMF_SRGS_SAPIPROPERTIES', 'SVP_16',
    'SPDKL_CurrentConfig', 'SPWF_INPUT', 'STCInprocServer',
    'SpeechDisplayAttributes', 'DISPID_SWFEBitsPerSample',
    'SpWaveFormatEx', 'SpeechPropertyAdaptationOn',
    'DISPID_SVSCurrentStreamNumber', 'SGRSTTWildcard',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpCompressedLexicon',
    'SPSHORTCUTPAIRLIST', 'DISPID_SpeechRecoResultTimes',
    'SVSFIsFilename', 'SVPNormal', 'DISPID_SpeechFileStream',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SpeechAudioFormat',
    'ISpeechXMLRecoResult', 'SPFM_OPEN_READWRITE',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SPPValue', 'ISpeechGrammarRuleStateTransitions',
    'SRERecoOtherContext', 'DISPID_SOTMatchesAttributes',
    'ISpeechRecoGrammar', 'DISPID_SRRAudio',
    ...
    'ISpRecognizer2', 'SREAudioLevel', 'SAFT22kHz8BitStereo',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SAVolume',
    'SSTTWildcard', 'ISpeechVoiceStatus', 'SpShortcut',
    'SpeechVoiceCategoryTTSRate', 'SDTDisplayText',
    'DISPID_SLPPartOfSpeech', 'ISpRecoResult', 'SAFT24kHz8BitStereo',
    'STSF_FlagCreate', 'SAFTGSM610_22kHzMono', 'DISPID_SPIRule',
    'SPEI_TTS_BOOKMARK', 'SPGS_ENABLED', 'SpInprocRecognizer',
    'SP_VISEME_9', 'SREPhraseStart', 'DISPIDSPTSI_SelectionLength',
    'SRAImport', 'IEnumString', 'ISpeechAudioStatus',
    'SPEI_RESERVED1', 'SITooQuiet', 'DISPID_SWFEExtraData',
    'DISPID_SPAs_NewEnum', 'SpeechVoicePriority', 'SPPARTOFSPEECH',
    'eLEXTYPE_PRIVATE12', 'DISPID_SRRSpeakAudio', 'DISPID_SRGReset',
    'SpPhraseInfoBuilder', 'DISPID_SPISaveToMemory', 'SPPS_Noun',
    'SECFNoSpecialChars', 'DISPID_SGRsCommitAndSave', 'SVP_9',
    'SDA_Two_Trailing_Spaces', 'ISpeechLexicon',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPRules_NewEnum', 'SRTExtendableParse',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPPChildren',
    'ISpeechRecognizer', 'DISPID_SRCEAudioLevel', 'DISPID_SVSkip',
    'SPAS_CLOSED', 'DISPID_SVEStreamEnd',
    'SpeechEmulationCompareFlags', 'ISpRecoGrammar2',
    'DISPID_SRCAudioInInterferenceStatus', 'SRSInactiveWithPurge',
    'DISPID_SGRSTPropertyName', 'SAFT12kHz16BitStereo'
]

_check_version('1.1.14', 1628000724.057435)
